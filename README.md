...
- `Tool Debugging`, it's to help fetching why tool crashed and generate file that's help to solve the problem. [@WheresMyRide](https://github.com/WheresMyRide)
...
- Add some UI labels.
  - Unreal Version: That's fetch which UE that game development with. [@WheresMyRide](https://github.com/WheresMyRide)
...
Console allocation has now been moved into the debugging class.
